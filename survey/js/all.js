!function (t) {
    ...
    i.mixin(e.animationEffects, {
        scale: function (t, e, s, n) {
            ...
            if (t.style["-webkit-backface-visibility"] = "hidden", t.style["-webkit-transform-style"] = "preserve-3d", t.style.position = "absolute", this.wrapAll.style.webkitPerspective = 4 * l, r === this.curIndex) {
                t.style.zIndex = 1, t.style["-webkit-transform"] = "rotate" + a + "(0deg) translateZ(0) scale(1)"
            } else {
                var o = r === this.curIndex + 1, d = this.curIndex === this.slidesLen - 1 && 0 === r, y = o || d ? 1 : -1;
                t.style.zIndex = 0, t.style["-webkit-transform"] = "rotate" + a + "(" + 90 * y + "deg) translateZ(" + 0.888 * l / 2 + "px) translate" + e + "(" + s + "px) scale(0.888)"
            }
...
!function (t, i, s) {
    ...
    l.prototype = {
        constructor: l, isScrollContain: function (t) {
            ...
            if (o.isMobile()) {
                o.bind(t, "touchstart", this._touchstart.bind(this)), o.bind(t, "touchmove", this._touchmove.bind(this)), o.bind(t, "touchend", this._touchend.bind(this))
            } else {
            ...
            if (i) {
                return this.scrollEle = i, this.scrollEleDire = o.attr(i, "scroll"), !1
            }
...
!function (e, t) {
    function r() {
        this.resources = {}, this.audio = {}, this.video = {}
    }

    var o = e.EasySlide, n = o.utils;
    r.prototype = {
        constructor: r, getFilename: function (e) {
            return e.slice(e.lastIndexOf("/") + 1).replace(/\?.*$/, "").toLowerCase()
        }, getExtName: function (e) {
            return e.slice(e.lastIndexOf(".") + 1, e.length).toLowerCase()
        }, getCreateNode: function (e) {
            var t = {img: ["jpg", "jpeg", "gif", "png", "bmp"]};
            for (var r in t) {
                if (t.hasOwnProperty(r) && t[r].indexOf(e) > -1) {
                    return r
                }
            }
            return null
        }, _getResourcesMap: function (e) {
            var t = this;
            e.forEach(function (e) {
                var r, o, n;
                if ("object" == typeof e ? (r = e.name, o = t.getExtName(e.path), n = e.path) : (r = t.getFilename(e), o = t.getExtName(e), n = e), t.resources[r] = {
                        path: n,
                        name: r,
                        type: o,
                        node: t.getCreateNode(o)
                    }, null === t.resources[r].node) {
                    throw new Error("load resource ext is not support" + o + "," + n)
                }
            })
        }, _fetch: function (e, r) {
            var o = e.path, i = e.node, s = t.createElement(i);
            "img" === i && (s.onload = s.onerror = function () {
                n.remove(s), r()
            }), s.style.display = "none", s.src = o, t.body.appendChild(s)
        }, loader: function (e) {
            function t() {
                n++, r.trigger("progress", [(n / o * 100).toFixed(2)]), n === o && r.trigger("loaded")
            }

            var r = this, o = 0, n = 0;
            this._getResourcesMap(e), o = Object.keys(this.resources).length;
            for (var i in this.resources) {
                this.resources.hasOwnProperty(i) && this._fetch(this.resources[i], t)
            }
        }
    };
    var i = o.prototype.init;
    o.prototype.init = function () {
        r.call(this), i.call(this)
    }, o.prototype = n.mixin(o.prototype, r.prototype)
}(window, document);
